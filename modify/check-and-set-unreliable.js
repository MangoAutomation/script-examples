...
const dataPointRT = runtimeManager.getDataPoint(dataPointID).setAttribute(DataSourceRT.ATTR_UNRELIABLE_KEY, true);
...
const dsRTs = runtimeManager.getRunningDataSources();
